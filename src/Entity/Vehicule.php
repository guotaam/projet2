...
class Vehicule
{
    ...
    public function addMembre(Commande $membre): self
    {
        if (!$this->membre->contains($membre)) {
            $this->membre->add($membre);
            $membre->setVehicule($this);
        }

        return $this;
    }

    public function removeMembre(Commande $membre): self
    {
        if ($this->membre->removeElement($membre)) {
            // set the owning side to null (unless already changed)
            if ($membre->getVehicule() === $this) {
                $membre->setVehicule(null);
            }
        }
